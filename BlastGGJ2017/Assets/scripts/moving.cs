...
public class moving : MonoBehaviour {
	...
	void FixedUpdate(){
		...
		//TRANSLATE
		var horzL = Input.GetAxis("P1X360_LstickX");
		var vertL = Input.GetAxis("P1X360_LstickY");
		...
		//ROTATE
		if (Input.GetAxis("P1X360_RstickX") > 0){
			var horz = Input.GetAxis ("P1X360_RstickX");
			//Debug.Log (horz);
			print("ITS ROTATING");
